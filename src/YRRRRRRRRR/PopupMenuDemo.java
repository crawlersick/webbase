...
public class PopupMenuDemo implements ActionListener, ItemListener {
    ...
    public JMenuBar createMenuBar() {
        ...
        ImageIcon icon = createImageIcon("images/154.png");
    ...
    public Container createContentPane() {
        ...
        JTable JT=Inittable.create();
        
        JTListSelectionListener JTlsl=new JTListSelectionListener(output,JT);
        JT.getSelectionModel().addListSelectionListener(JTlsl);
        JT.addMouseListener(JTlsl);
       // JT.addKeyListener(JTlsl);
        contentPane.add(JT, BorderLayout.NORTH);
